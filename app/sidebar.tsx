...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    if (pathname === "/backoffice/setting" || pathname === "/backoffice/users" || pathname === "/backoffice/administrator") {

      if (level !== "Admin") {
        // Swal.fire({
        //   icon: "error",
        //   title: "ไม่อนุญาตให้เข้าถึง",
        //   text: "คุณไม่มีสิทธิ์เข้าใช้งานในส่วนนี้",
  ...
  return (
    <div
      className={`sticky top-0 left-0 z-[100] 
        bg-[#188875] h-screen rounded-[10px]
    ...
    >
      <div className="relative w-full h-full">
        <div className="text-sm xl:text-base flex flex-col justify-center items-center space-y-2">
          ...
          >
            <svg
                ...
                fill={
                  pathname === "/backoffice/dashboard" ? "#188875" : "#FFFFFF"
                }
              >
          ...
          >
            <svg
              ...
              fill={pathname === "/backoffice/users" ? "#188875" : "#FFFFFF"}
            >
          ...
          > 
            ...
            >
              <path
                ...
                stroke={(pathname === "/backoffice/report/TrafficVolume") || 
                (pathname === "/backoffice/report/ListAccount") ||
                (pathname.startsWith("/backoffice/report/AccountDetails/"))
          ...
          <ButtomSidebar
            ...
            >
              <svg
                ...
                className="w-[25px] h-[20px]"
                fill={
                  pathname === "/backoffice/eventlog" ? "#188875" : "#FFFFFF"
                }
              >
          ...
          <ButtomSidebar
            ...
            >
              <svg
                ...
                className="w-[25px] h-[20px]"
                fill={
                  pathname === "/backoffice/setting" ? "#188875" : "#FFFFFF"
                }
              >
        ...
        <div className="text-sm xl:text-base w-full absolute bottom-10 flex flex-col justify-center items-center gap-2">
          ...
          <button
            className="max-w-[300px] bg-oxbowteal flex flex-row justify-center items-center gap-3 p-3 rounded-md shadow-md border-1 hover:border-lessenteal"
